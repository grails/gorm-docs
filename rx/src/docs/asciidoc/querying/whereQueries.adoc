...
For more information on the syntax of where queries see the https://docs.grails.org/latest/guide/GORM.html#whereQueries[relevant section in the GORM documentation].
